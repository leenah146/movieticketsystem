...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                .authorizeRequests()
                .antMatchers("/api/v1/movie/register","/api/v1/movie/show","/api/v1/movie/days","/api/v1/movie/now").permitAll()
                ...
                .antMatchers(HttpMethod.DELETE,"/api/v1/movie/mov","/api/v1/meal").hasAuthority("Admin")
